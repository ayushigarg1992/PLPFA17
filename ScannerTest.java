...
public class ScannerTest {
	...
	public void test8() throws LexicalException {
    	//To-do check legitimate tokens in case of string literal
		String input = "\"@ x X y Y int\"@!==";
    	show(input);
    	//thrown.expect(LexicalException.class);  //Tell JUnit to expect a LexicalException
    	try {
    		Scanner scanner =new Scanner(input).scan();
	...
	public void test9() throws LexicalException {
    	//To-do check legitimate tokens in case of string literal containing escape sequence
		String input = "file file1 \"\\n\\t\"log log1 0abs";
    	show(input);
    	//thrown.expect(LexicalException.class);  //Tell JUnit to expect a LexicalException
    	try {
    		Scanner scanner =new Scanner(input).scan();
